<h3>
    <?php echo !empty($content) ? $content : Wcr_Slide_settings::$options['wcr_slider_title']; ?>
</h3>
<div class="wcr_slider flexslider">
    <ul class="slides">
        <?php
        $filter = array(
        ...
        if ($query->have_posts()):
            while ($query->have_posts()):
                ...
                ?>
                <li>
                    <?php the_post_thumbnail(array(1200,200), array('class' => 'img-fluid')); ?>
